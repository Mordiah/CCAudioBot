...
namespace CCAudioBot.Dialogs
{
    ...
    public class ClearComForm
    {
        ...
        public static IForm<ClearComForm> BuildForm()
        {
            ...
            return new FormBuilder<ClearComForm>()
        ...
        public static ActiveDelegate<ClearComForm> DropLocationActive => (state) => state.PickLocation != null;
        public static ActiveDelegate<ClearComForm> DropDateTimeActive => (state) => !string.IsNullOrWhiteSpace(state.PickDateAndTime);
    }
